...
# P.S.
Для нормального отображения картинок кинотеатров на фронте, нужно все картинки из resources/static/cinemas вручную закинуть в S3-хранилище в баккет cinemas (http://{адрес_вашего_стенда}:9001/)
...
0. Установите в своей системе следующие переменные окружения:<br>
    CBS_POSTGRES_URL - адрес для подключения к базе данных в формате *jdbc:postgresql://ваш_адрес:ваш_порт/название_базы*<br>
    CBS_POSTGRES_USER - имя пользователя базы данных<br>
    CBS_POSTGRES_PASSWORD - пароль пользователя базы данных<br>
